...
function optinforms_form3_default_title() {
	...
	if ( is_admin() ) {
		...
		return do_shortcode( $optinforms_form3_title );
	}
}
...
function optinforms_form3_default_subtitle() {
	...
	if ( is_admin() ) {
		...
		return do_shortcode( $optinforms_form3_subtitle );
	}
}
...
function optinforms_form3_default_name_field() {
	...
	if ( is_admin() ) {
		...
		return do_shortcode( $optinforms_form3_name_field );
	}
}
...
function optinforms_form3_default_email_field() {
	...
	if ( is_admin() ) {
		...
		return do_shortcode( $optinforms_form3_email_field );
	}
}
...
function optinforms_form3_default_button_text() {
	...
	if ( is_admin() ) {
		...
		return do_shortcode( $optinforms_form3_button_text );
	}
}
