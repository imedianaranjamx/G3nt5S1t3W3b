<?php ?>
                    ...
                    <div class="toggle-container" style="display: none;">
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form3_title" name="optinforms_form3_title" value="<?php echo esc_attr( optinforms_form3_default_title() ); ?>" onchange='optinforms_change_form3_title()' <?php if (get_option('optinforms_form3_hide_title')== '1') { echo 'disabled="disabled"'; } ?> />
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form3_subtitle" name="optinforms_form3_subtitle" value="<?php echo esc_attr( optinforms_form3_default_subtitle() ); ?>" onchange='optinforms_change_form3_subtitle()' <?php if (get_option('optinforms_form3_hide_subtitle')== '1') { echo 'disabled="disabled"'; } ?> />
                                <script type="text/javascript">
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form3_name_field" name="optinforms_form3_name_field" value="<?php echo esc_attr( optinforms_form3_default_name_field() ); ?>" onchange='optinforms_change_form3_name_field()' <?php if (get_option('optinforms_form3_hide_name_field')== '1') { echo 'disabled="disabled"'; } ?> />
                                <script type="text/javascript">
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form3_email_field" name="optinforms_form3_email_field" value="<?php echo esc_attr( optinforms_form3_default_email_field() ); ?>" onchange='optinforms_change_form3_email_field()' />
                                <script type="text/javascript">
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form3_button_text" name="optinforms_form3_button_text" value="<?php echo esc_attr( optinforms_form3_default_button_text() ); ?>" onchange='optinforms_change_form3_button_text()' />
                                <script type="text/javascript">
