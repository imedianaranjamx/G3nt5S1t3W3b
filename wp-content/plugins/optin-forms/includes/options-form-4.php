<?php ?>
                    ...
                    <div class="toggle-container" style="display: none;">
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form4_title" name="optinforms_form4_title" value="<?php echo esc_attr( optinforms_form4_default_title() ); ?>" onchange='optinforms_change_form4_title()' <?php if (get_option('optinforms_form4_hide_title')== '1') { echo 'disabled="disabled"'; } ?> />
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form4_subtitle" name="optinforms_form4_subtitle" value="<?php echo esc_attr( optinforms_form4_default_subtitle() ); ?>" onchange='optinforms_change_form4_subtitle()' <?php if (get_option('optinforms_form4_hide_subtitle')== '1') { echo 'disabled="disabled"'; } ?> />
                                <script type="text/javascript">
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form4_email_field" name="optinforms_form4_email_field" value="<?php echo esc_attr( optinforms_form4_default_email_field() ); ?>" onchange='optinforms_change_form4_email_field()' />
                                <script type="text/javascript">
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form4_button_text" name="optinforms_form4_button_text" value="<?php echo esc_attr( optinforms_form4_default_button_text() ); ?>" onchange='optinforms_change_form4_button_text()' />
                                <script type="text/javascript">
                        ...
                        <div class="optiongroup">
                            ...
                            <div class="optionmiddle">
                                <input type="text" id="optinforms_form4_disclaimer" name="optinforms_form4_disclaimer" value="<?php echo esc_attr( optinforms_form4_default_disclaimer() ); ?>" onchange='optinforms_change_form4_disclaimer()' <?php if (get_option('optinforms_form4_hide_disclaimer')== '1') { echo 'disabled="disabled"'; } ?> />
                                <script type="text/javascript">
