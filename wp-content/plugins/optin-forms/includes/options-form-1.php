                    ...
                    <div class="toggle-wrap">
                        ...
                        <div class="toggle-container" style="display: none;">
                            ...
                            <div class="optiongroup">
                                ...
                                <div class="optionmiddle">
                                    <input type="text" id="optinforms_form1_title" name="optinforms_form1_title" value="<?php echo esc_attr( optinforms_form1_default_title() ); ?>" onchange='optinforms_change_form1_title()' <?php if (get_option('optinforms_form1_hide_title')== '1') { echo 'disabled="disabled"'; } ?> />
                            ...
                            <div class="optiongroup">
                                ...
                                <div class="optionmiddle">
                                    <input type="text" id="optinforms_form1_subtitle" name="optinforms_form1_subtitle" value="<?php echo esc_attr( optinforms_form1_default_subtitle() ); ?>" onchange='optinforms_change_form1_subtitle()' <?php if (get_option('optinforms_form1_hide_subtitle')== '1') { echo 'disabled="disabled"'; } ?> />
                                    <script type="text/javascript">
                            ...
                            <div class="optiongroup">
                                ...
                                <div class="optionmiddle">
                                    <input type="text" id="optinforms_form1_name_field" name="optinforms_form1_name_field" value="<?php echo esc_attr( optinforms_form1_default_name_field() ); ?>" onchange='optinforms_change_form1_name_field()' <?php if (get_option('optinforms_form1_hide_name_field')== '1') { echo 'disabled'; } ?> />
                                    <script type="text/javascript">
                            ...
                            <div class="optiongroup">
                                ...
                                <div class="optionmiddle">
                                    <input type="text" id="optinforms_form1_email_field" name="optinforms_form1_email_field" value="<?php echo esc_attr( optinforms_form1_default_email_field() ); ?>" onchange='optinforms_change_form1_email_field()' />
                                    <script type="text/javascript">
                            ...
                            <div class="optiongroup">
                                ...
                                <div class="optionmiddle">
                                    <input type="text" id="optinforms_form1_button_text" name="optinforms_form1_button_text" value="<?php echo esc_attr( optinforms_form1_default_button_text() ); ?>" onchange='optinforms_change_form1_button_text()' />
                                    <script type="text/javascript">
                            ...
                            <div class="optiongroup">
                                ...
                                <div class="optionmiddle">
                                    <input type="text" id="optinforms_form1_disclaimer" name="optinforms_form1_disclaimer" value="<?php echo esc_attr( optinforms_form1_default_disclaimer() ); ?>" onchange='optinforms_change_form1_disclaimer()' <?php if (get_option('optinforms_form1_hide_disclaimer')== '1') { echo 'disabled="disabled"'; } ?> />
                                    <script type="text/javascript">
