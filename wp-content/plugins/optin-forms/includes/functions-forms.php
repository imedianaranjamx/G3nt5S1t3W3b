				...
				<div id="optinforms-form6-container" class="optinforms-form-container">
					...
					<form method="post" <?php echo optinforms_form_target_blank(); ?> action="<?php echo optinforms_get_form_action(); ?>" <?php echo optinforms_form_action_appendix(); ?>>
						...
						<div id="optinforms-form6">
							<input required type="text" id="optinforms-form6-email-field" name="<?php echo optinforms_get_email_field(); ?>" placeholder="<?php echo optinforms_form6_default_email_field(); ?>" />
