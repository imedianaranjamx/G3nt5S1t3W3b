...
function optinforms_form1_default_title() {
	...
	if ( is_admin() ) {
		...
		return do_shortcode( $optinforms_form1_title );
	}
}
...
function optinforms_form1_default_subtitle() {
	...
	if ( is_admin() ) {
		...
		return do_shortcode( $optinforms_form1_subtitle );
	}
}
...
function optinforms_form1_default_name_field() {
	...
	if ( is_admin() ) {
		...
		return do_shortcode( $optinforms_form1_name_field );
	}
}
...
function optinforms_form1_default_email_field() {
	...
	if ( is_admin() ) {
		...
		return do_shortcode( $optinforms_form1_email_field );
	}
}
...
function optinforms_form1_default_button_text() {
	...
	if ( is_admin() ) {
		...
		return do_shortcode( $optinforms_form1_button_text );
	}
}
...
function optinforms_form1_default_disclaimer() {
	...
	if ( is_admin() ) {
		...
		return do_shortcode( $optinforms_form1_disclaimer );
	}
}
