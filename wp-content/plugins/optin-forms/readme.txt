...
This plugin has been featured on [DesignBombs](https://www.designbombs.com/best-email-list-building-plugins-wordpress/), [Onextrapixel](https://onextrapixel.com/best-wordpress-mailing-list-plugins-for-getting-more-subscribers/), and [more](http://optinforms.io/reviews).
...
If are you looking for other alternatives check-out our article on [best list building plugins](https://www.wpkube.com/list-building-wordpress-plugins/). Also take a look at our guides on [how to install WordPress](http://www.wpkube.com/install-wordpress/), [choose best WordPress hosting](http://www.wpkube.com/best-wordpress-hosting), and [more](https://www.wpkube.com/category/wordpress-tutorials/).
...
= 1.2.9.1 =
* Fixes issue with MailChimp when there are multiple instances of the form on the page

= 1.2.9.0 =
* Updated information for GetResponse
